def udregnmm():
    ...
    while taller==2:
        ...
        print("")
        print("Ved brug af MM850 skal den valgte konnekter understøtte ", linkmmfiber850,"dB")
        print("Ved brug af MM1500 skal den valgte konnekter understøtte ", linkmmfiber1300,"dB")
        print("")
