def udregnsm():
    ...
    print("")
    print("Ved brug af SM1310 skal den valgte konnekter understøtte ", linksmfiber1310,"dB")
    print("Ved brug af SM1550 skal den valgte konnekter understøtte ", linksmfiber1550,"dB")
    print("")
